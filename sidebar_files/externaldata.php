...
$countSql = "SELECT COUNT(*) as memberCount FROM externals";
...
<div class="div-container">
    ...
    <div class="dataset">
    <div class="totalcount">TOTAL EXTERNAL DATA - <?php echo $memberCount; ?></div>
        <div class="div-icon">
            <div class="searchbar">
                <img
                    loading="lazy"
    ...
    <thead>
                <tr>
                    ...
                    <th>Phone Number</th>
                    <th>Items ordered</th>
                    <th>Quantity of each item ordered</th>
